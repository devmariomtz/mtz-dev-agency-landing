      ...
      <div className="container mx-auto flex px-5 pb-23 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <p className="mb-8 leading-loose text-xl text-justify">
            ...
            especializada en la prestación de servicios personalizados. Desde la
            creación de sitios web hasta el desarrollo de soluciones
            tecnologicas a medida donde destacamos en la atención a las
