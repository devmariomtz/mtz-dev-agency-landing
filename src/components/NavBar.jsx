...
const NavBar = () => {
  ...
  return (
    <>
        ...
        <nav className="w-full h-full flex justify-center">
          <ul className="flex flex-col justify-center items-start gap-20 my-[50%] ">
            <li className="animate-fade-up">
              <a
                href="/"
                className="hover:underline underline-offset-8 text-xl"
              >
                🏠 Inicio
              </a>
            </li>
      ...
      {/* desktop menu */}
      {/* <div className="hidden xl:flex lg:flex w-[40%] items-center border-red-600">
        <nav className="w-full border-red-600">
          <ul className="border-red-600">
            ...
            <li className="animate-fade-down border-red-600">
      ...
      {/* btn cta */}
      {/* <div className="hidden xl:flex lg:flex w-[40%] items-center justify-end border-red-600">
        <button className="animate-fade-down bg-red-600 text-white p-2 rounded-lg">
          📧 Contacto
        </button>
      </div> */}
    </>
