          ...
          <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
            ...
            <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
              ...
              <p className="leading-relaxed">
                ...
                clientes y aunmentar las ventas.
              </p>
            </div>
          </div>
        </div>
        <div className="flex relative pb-14 sm:items-center md:w-2/3 mx-auto">
          <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
            ...
            <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
              ...
              <p className="leading-relaxed">
                Desde la ideación hasta la ejecución, nos especializamos en dar
                vida a sus visiones de software, potenciando su negocio con
        ...
        <div className="flex relative pb-14 sm:items-center md:w-2/3 mx-auto">
          <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
            ...
            <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
              ...
              <p className="leading-relaxed">
                Integre a la perfección sus sistemas existentes o adáptelos para
                cumplir los estándares del sector en constante evolución,
                garantizando un rendimiento y una eficiencia óptimos.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex relative pb-14 sm:items-center md:w-2/3 mx-auto">
          <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
            ...
            <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
              ...
              <p className="leading-relaxed">
                Aproveche el poder de la nube con nuestra experiencia en la
                implementación de tecnologías en la nube, mejorando la
                escalabilidad, la seguridad y la accesibilidad de su negocio.
              </p>
            </div>
          </div>
        </div>
